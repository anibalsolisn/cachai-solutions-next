    ...
    <div key={i} style={{
      ...
      <div style={{ position: 'absolute', top: 0, left: 60, right: '50%', bottom: 0, zIndex: 2, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 16, marginTop: 40, flexWrap: 'wrap' }}>
          <a href="/#contacto" style={{ background: '#7de0f0', color: '#0d2030', padding: '12px 24px', borderRadius: 4, fontSize: 13, fontWeight: 700, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
            Probemos juntos →
          </a>
          <a href="/#casos" style={{ background: 'rgba(255,255,255,.12)', color: '#fff', padding: '12px 24px', borderRadius: 4, fontSize: 13, fontWeight: 600, textDecoration: 'none' }}>
            Ver resultados
          </a>
        </div>
      </div>
