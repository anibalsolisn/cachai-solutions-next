        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr', gap: 60, marginBottom: 64, paddingBottom: 64, borderBottom: '1px solid rgba(255,255,255,.08)' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 14, color: 'rgba(255,255,255,.4)', lineHeight: 1.8, maxWidth: 260, marginBottom: 24 }}>
              Consultora especializada en Shopify y Growth Marketing. Escalamos tiendas online con estrategia, datos y ejecución de alto nivel.
            </p>
          ...
          <div>
            <div style={{ fontSize: 10, fontWeight: 600, letterSpacing: '.16em', textTransform: 'uppercase', color: 'rgba(255,255,255,.25)', marginBottom: 20 }}>Construir</div>
            {[
              { label: 'Ecommerce & Shopify', href: '/shopify' },
              { label: 'Migraciones', href: '/migrations' },
          ...
          <div>
            <div style={{ fontSize: 10, fontWeight: 600, letterSpacing: '.16em', textTransform: 'uppercase', color: 'rgba(255,255,255,.25)', marginBottom: 20 }}>Crecer</div>
            {[
          ...
          <div>
            <div style={{ fontSize: 10, fontWeight: 600, letterSpacing: '.16em', textTransform: 'uppercase', color: 'rgba(255,255,255,.25)', marginBottom: 20 }}>Empresa</div>
            {[
